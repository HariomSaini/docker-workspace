...
JAVA_OPTS="$JAVA_OPTS -javaagent:/data/jmx_prometheus_javaagent-0.11.0.jar=8090:/data/prometheus-jmx-config.yaml -Djava.protocol.handler.pkgs=org.apache.catalina.webresources"
